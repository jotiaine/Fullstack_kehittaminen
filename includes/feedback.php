...
<div id="feedback-container"
  class="container-fluid d-flex flex-column align-items-center justify-content-center text-center bg-dark h-100">
  ...
  <div id="search-bar" class="input-group d-flex justify-content-center align-center pb-3 shadow-sm w-75">
    <div class="form-outline">
      <input id="search-text" name="search-text" type="text"
        class="form-control bordered border-primary bg-dark text-white" placeholder="Search" />
    </div>
  ...
  <table id="search-result"
    class="table-style table gy-3 text-light table-borderless table-dark table-striped table-hover d-none w-50 mb-5 shadow">
  </table>

  <table id="feedback-table"
    class="table-style table text-light table-borderless table-dark table-striped table-hover w-50 shadow">
    <!-- Results here -->
    <?php
    if ($rows > 0) {

  ...
  <div class="modal-dialog">
    <div class="modal-content bg-light">
      ...
      <div class="d-flex flex-column modal-footer justify-content-center">
        ...
        <!-- STUDENT FORM -->
        <form id="studentForm" class="m-0 text-center d-none  shadow-lg p-3" action="index.php?page=test&user=student"
          method="post">
          <div>
          ...
          <div>
            <button id="submit-student" type="submit" class="btn btn-dark mt-3 shadow-lg"
              name="submit-student">BEGIN</button>
          </div>
        </form>
